...
userSchema.pre(["deleteOne", "findOneAndDelete"], async function (next) {
  try {
    ...
    if (employee) {
      console.log(
        `Found employee profile: ${employee._id}, cleaning up employee data`
      );
      ...
      console.log(
        `Deleted ${deletedAttendance.deletedCount} attendance records`
      );
      ...
      console.log(
        `Deleted ${deletedLeaveRequests.deletedCount} leave requests`
      );
      ...
      console.log(
        `Deleted ${deletedLeaveBalances.deletedCount} leave balances`
      );
    ...
    try {
      ...
      console.log(
        `Notification model not available, skipping notification cleanup`
      );
    }
